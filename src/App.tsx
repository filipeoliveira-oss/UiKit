...
export default function App() {
	...
	return (
		<div className="w-full h-full pt-12 flex flex-col gap-28 px-[13%] mt-4">
			<HeroHeader/>

			<div className="flex-row grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] auto-rows-fr gap-4  h-auto">
